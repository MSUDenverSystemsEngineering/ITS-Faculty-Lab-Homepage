...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		[scriptblock]$HKCUFacultyLabRegistrySettings = {
			...
			Set-RegistryKey -Key "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\5.0" -Name "SyncMode5" -Value "3" -Type "DWord" -SID $UserProfile.SID
		}
		...
		Invoke-HKCURegistrySettingsForAllUsers -RegistrySettings $HKCUFacultyLabRegistrySettings
		Write-Log -Message "Setting Firefox homepage..." -Severity 1 -Source $deployAppScriptFriendlyName
		Copy-File -Path "$dirFiles\cck2.cfg" -Destination "$envProgramFilesX86\Mozilla Firefox" -ContinueOnError $true
		Write-Log -Message "Setting Chrome homepage..." -Severity 1 -Source $deployAppScriptFriendlyName
		Copy-File -Path "$dirFiles\master_preferences" -Destination "$envProgramFilesX86\Google\Chrome\Application" -ContinueOnError $true
		...
		Set-RegistryKey -Key "HKLM\SOFTWARE\MSUDenver\InternetExplorer" -Name "Updates" -Value "Enabled" -Type "String"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message, close browsers with a 60 second countdown before automatically closing
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgEJ0bVSKJtRaK
# rZxwp9s8CaEPepnwIp53xMtf1ddooaCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIOtn
# Cc8U8lhiPgAsofq4QeWBcuMiiDTkLcJhSDfKdrcJMA0GCSqGSIb3DQEBAQUABIIB
# AIcOLicd0VQsRO8KTZQDRGDiRmddvhJXDtO4yBiDFtd32GIsGJ3WLMAcwVmKR8cX
# ZihXgwzQWOaZMZOBuMyjZk43TKytNeluMRyjV5QjhCSVLxb5ZzB9nrjbNTAgwMIo
# DJV/1ZEA2AiGFfidbUA7gxmm0y4Z4hd63UjP9fX1DThNXxfUxGwEL1TZi2ka01kn
# PB4ENCry9UoEKGgQu9kpQ1NIlnL75SFGyTKYBxhMo8eOGW91P5auU0GfBFc1946P
# Cy6nq/I2xeI1ZmLoD5qD6LVeGKxUEZKGrKxFlZYQcmQgNFgInky6YTM0GuvnvSmW
# YLPaX/uKcJtBEtrOdxRjxAyhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwNjE1MTQ1MjA4WjAjBgkqhkiG9w0BCQQxFgQU
# 1FAF/ngxG6LnLkRQdCnhVRWt4qEwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAHJZ/Pc6MFAVHLXlLDo8b03qaLZj53AyiTm50rgSs3rgi1GQDN/Iamca
# avkQj/GSoJuLc68tlj9rB+YmXIVQpGq9Ch5xDLUSS2ThfvKCouUBGLBg/YiTFPOK
# TUsueAn4ig6xaWokDs6cIO8d9HOo729Bhb6nDZNDkqyDoECNW7wirVIXJGkRkqCT
# VunUU8Dv/hzNWlgx/lO9V4M2RR5j5AL7TAVNNJZblOM69dLqKe1mt3uxfRn9flaz
# pAMqgsZdWMFM2Mi8F1r63V+AwnING+4xVPNYx4kppQkmlBgOxeMkgpwKxtQ8b8YN
# ZbvjaO+2JCtR9FRDgpYUp8u082T8+pM=
